...
// ⚠️ 이 함수는 사용하지 않음 - transactionEditPriceHistoryModal로 통합됨
// 이전단가 조회 모달 열기
...
// ⚠️ 이 함수는 사용하지 않음 - transaction.js의 selectTransactionPriceFromHistory로 통합됨
...
// ⚠️ 이 함수는 transaction.js에서 정의됨 (Line 1584) - 여기서는 주석 처리
...
// ========================================
// ⚠️ 이전단가 조회 기능 - 사용 중단 (transactionEditPriceHistoryModal로 통합)
// ========================================

// ⚠️ 이 함수는 사용하지 않음 - transaction.js의 showTransactionEditPriceHistoryButton으로 통합됨
...
// ⚠️ 이 함수는 transaction.js에서 정의됨 - 여기서는 주석 처리
